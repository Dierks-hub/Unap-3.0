...
<head>
    ...
    <!-- Datatables -->
    <link href="https://cdn.datatables.net/v/bs5/jszip-3.10.1/dt-2.1.3/b-3.1.1/b-html5-3.1.1/b-print-3.1.1/r-3.0.2/datatables.min.css" rel="stylesheet">
...
<body class="bg-light d-flex flex-column min-vh-100" data-bs-theme="light">
                ...
                <div class="row d-flex mb-3 flex-md-row-reverse mt-1">
                    <div class="col-12 col-md-4 col-xl-2 mt-2">
                        <div class="card shadow-sm h-65">
                            ...
                            <div class="card-body">
                                <div class="list-group text-center md-text-left">
                    ...
                    <div class="col-12 col-md-8 col-xl-10 mt-2">
                        ...
                        <div class="card shadow-sm h-65">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="container p-3 my-5 border border-secondary">
    ...
    <footer class="bg-body-secondary mt-auto" id="footer">
        <div class="container-fluid bg-unap-dark">
            <div class="row">
                <div class="col-12">
                    <h5 class="my-3 px-5 text-light text-center">Videos Tutoriales</h5>
    ...
    <script src="https://cdn.datatables.net/v/bs5/jszip-3.10.1/dt-2.1.3/b-3.1.1/b-html5-3.1.1/b-print-3.1.1/r-3.0.2/datatables.min.js"></script>
